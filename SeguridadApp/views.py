...
def homePage(request):
    client = connect_mqtt()
    client.publish('control', 'lab4.stop')
    client.publish('control', 'lab4.foco1.stop')
    client.publish('control', 'lab4.foco2.stop')
    client.publish('control', 'lab4.ventilador.stop')
    context={} 
...
def connect_mqtt():
    ...
    client = mqtt_client.Client('cliente')
    client.username_pw_set('servidor', '1234')
